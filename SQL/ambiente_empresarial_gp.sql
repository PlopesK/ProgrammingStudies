...
-- Copiando dados para a tabela empresa.chefe: 0 rows
/*!40000 ALTER TABLE `chefe` DISABLE KEYS */;
/*!40000 ALTER TABLE `chefe` ENABLE KEYS */;

-- Copiando dados para a tabela empresa.departamento: 0 rows
/*!40000 ALTER TABLE `departamento` DISABLE KEYS */;
/*!40000 ALTER TABLE `departamento` ENABLE KEYS */;

-- Copiando dados para a tabela empresa.empregado: 0 rows
/*!40000 ALTER TABLE `empregado` DISABLE KEYS */;
/*!40000 ALTER TABLE `empregado` ENABLE KEYS */;

-- Copiando dados para a tabela empresa.projeto: 0 rows
