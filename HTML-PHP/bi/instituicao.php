...
$email= $_POST['email'];
$inserir = "INSERT INTO instituicao (instituicao_codigo, instituicao_nome, instituicao_endereco, instituicao_email)
VALUES ('$codigo', '$nome', '$endereco', '$email');";
mysql_query($inserir);
unset($_POST['inserir']);
header("Refresh:0");
}
...
$deletar = "DELETE FROM instituicao WHERE instituicao_codigo = $selecionado;";
mysql_query($deletar);
header("Refresh:0");
}
?>
<html lang="pt-br">
	...
	<body link="#81ECC5" style="background-color:#7ed6df;">
		...
		<div class= "alinhamento">
			<br><br><br><br><br>
			<t><center> Alterações com as Instituições</center></t>
			<br><br><br><br>
			...
			<form method="POST">
				...
				<div class="lista">
					<table>
						...
						<?php
						$contar = "SELECT COUNT(*) FROM instituicao;";
