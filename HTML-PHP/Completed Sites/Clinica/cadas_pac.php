<html lang="pt-BR">
	...
	<form action="ScriptCadasPaciente.php" method="POST">
		<p class="card">
			<br><br>
            <input type="text" name="nome" placeholder="Insira o Nome do Paciente">
			<br>
            <input type="text" name="rg" placeholder="Insira o RG do Paciente">
			<br><br><br>
