...
$inserir = "INSERT INTO autor (autor_codigo, autor_nome, autor_nacionalidade)
...
$deletar = "DELETE FROM autor WHERE autor_codigo = $selecionado;";
mysql_query($deletar);
header("Refresh:0");
}
?>
<html lang="pt-br">
	...
	<body link="#81ECC5" style="background-color:#7ed6df;">
		...
		<div class= "alinhamento">
			<br><br><br><br><br>
			<t><center> Alterações com os Autores</center></t>
			<br><br><br><br>
			...
			<form method="POST">
				...
				<div class="lista">
					...
					<?php
					$contar = "SELECT COUNT(*) FROM autor;";
					$pedido = mysql_fetch_row(mysql_query($contar));
					if($pedido[0] != 0) 
					{
						$selecionar = "SELECT * FROM autor;";
