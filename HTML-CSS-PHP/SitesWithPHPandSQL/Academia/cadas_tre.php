<html lang="pt-BR">
	<head>
		<title>Cadastro do Treinador</title>
		<style type="text/css">
			.card {
    ...
    <font size= "5" face= "Sans Serif" color= "#FD6E00">
		<H1><center> Cadastro do Treinador</center></H1>
		<H5><center> Insira as informações abaixo para que o cadastro seja bem sucedido</center></H5>
	</font>
    <br><br>
	
	<form action="ScriptCadasTreinador.php" method="POST">
		<p class="card">
			<br><br>
            <input type="text" name="nome" placeholder="Insira o Nome do Treinador">
			<br>
            <input type="text" name="rg" placeholder="Insira o RG do Treinador">
			<br><br><br>
