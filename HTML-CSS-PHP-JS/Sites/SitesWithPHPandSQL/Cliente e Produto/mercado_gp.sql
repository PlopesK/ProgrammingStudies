...
-- Copiando dados para a tabela mercado_gp.cliente: 3 rows
/*!40000 ALTER TABLE `cliente` DISABLE KEYS */;
INSERT INTO `cliente` (`cli_cpf`, `cli_nome`) VALUES
	(678, 'Felipe'),
	(345, 'Ana'),
	(123, 'Paulo');
...
CREATE TABLE IF NOT EXISTS `produto` (
  ...
  `pro_preco` decimal(10,0) DEFAULT NULL,
  PRIMARY KEY (`pro_cod`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela mercado_gp.produto: 1 rows
/*!40000 ALTER TABLE `produto` DISABLE KEYS */;
INSERT INTO `produto` (`pro_cod`, `pro_nome`, `pro_desc`, `pro_preco`) VALUES
	(1, 'Maçã', 'Vermelinha hmmm', 0);
